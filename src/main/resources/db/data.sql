...
VALUES ('ssar@nate.com', '1234', '010-1234-5678', 'Email', '2023-02-15', '1990-01-15'),
       ('john@gmail.com', '1234', '010-2345-6789', 'Email', '2023-04-25', '1985-03-22'),
       ...
       ('tom@gmail.com', '1234', '010-6789-0123', 'Email', '2023-11-20', '1991-11-10'),
       ('emily@naver.com', '1234', '010-7890-1234', 'Kakao', '2023-12-15', '1987-04-05'),
       ('chris@gmail.com', '1234', '010-8901-2345', 'Email', '2024-01-05', '1993-02-17'),
...
VALUES ('노을', 'Solo', 'upload/노을.jpg', now()),
       ...
       ('TWS (투어스)', 'Group', 'upload/tws.jpg', '2023-06-10'),
       ('QWER', 'Group', 'upload/qwer.jpg', '2023-07-15'),
       ('임영웅', 'Solo', 'upload/hero.jpg', '2023-08-20'),
       ('지코 (ZICO)', 'Solo', 'upload/zico.jpg', '2023-09-25'),
       ('(여자)아이들', 'Group', 'upload/gidle.jpg', '2023-10-30'),
       ('아일릿(ILLIT)', 'Group', 'upload/illit.jpg', '2023-11-15'),
       ('이클립스 (ECLIPSE)', 'Solo', 'upload/eclipse.jpg', '2023-12-01');
