...
public class PlaylistService {
    ...
    public List<PlaylistResponse.PlaylistDTO> musicTest() {
        ...
        songs.add(new PlaylistResponse.PlaylistDTO("고민중독", "QWER", "/upload/song/고민중독.mp3", "/upload/album/고민중독.jpg","One! Two! Q! W! E! R! "));
        songs.add(new PlaylistResponse.PlaylistDTO("봄여름가을겨울", "빅뱅", "/upload/song/봄여름가을겨울.mp3", "/upload/album/봄여름가을겨울.jpg","이듬해 질 녘 꽃 피는 봄"));
        songs.add(new PlaylistResponse.PlaylistDTO("슈퍼노바", "에스파", "/upload/song/슈퍼노바.mp3", "/upload/album/슈퍼노바.jpg","I’m like some kind of Supernova"));
        return songs;
